...
class WinemakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winemaker" do
    assert_difference("Winemaker.count") do
      post winemakers_url, params: { winemaker: { age: @winemaker.age, magazine: @winemaker.magazine, name: @winemaker.name, nationality: @winemaker.nationality, position: @winemaker.position, record: @winemaker.record } }
    end
  ...
  test "should update winemaker" do
    patch winemaker_url(@winemaker), params: { winemaker: { age: @winemaker.age, magazine: @winemaker.magazine, name: @winemaker.name, nationality: @winemaker.nationality, position: @winemaker.position, record: @winemaker.record } }
